...
class Generator:
    def __init__(self):
        self.layer_sizes = [1024,512,256,128,3]
        with tf.variable_scope('g'):
            ...
            self.W5 = init_weights([3,3,self.layer_sizes[3], self.layer_sizes[3]])
            self.W6 = init_weights([3,3,self.layer_sizes[4], self.layer_sizes[3]])
